...
describe(_model + ' Authentication routes tests', function () {
    ...
    it('should be ' + _model + ' signup duplicate username (status 400)', function (done) {
        ...
        request(app)
            ...
            .expect(400)
            .end(function (err, res) {
                assert.notEqual(res.body.message.toLowerCase().indexOf('username already exists'), -1);
                done();
            });
    ...
    it('should be ' + _model + ' signup duplicate email (status 400)', function (done) {
        ...
        request(app)
            ...
            .expect(400)
            .end(function (err, res) {
                assert.notEqual(res.body.message.toLowerCase().indexOf('email already exists'), -1);
                done();
            });
    ...
    it('should be ' + _model + ' signup if no firstname is provided (status 400)', function (done) {
        ...
        request(app)
            ...
            .expect(400)
            .end(function (err, res) {
                assert.notEqual(res.body.message.toLowerCase().indexOf('please fill in your first name'), -1);
                done();
            });
    ...
    it('should be ' + _model + ' signup if no lastname is provided (status 400)', function (done) {
        ...
        request(app)
            ...
            .expect(400)
            .end(function (err, res) {
                assert.notEqual(res.body.message.toLowerCase().indexOf('please fill in your last name'), -1);
                done();
            });
